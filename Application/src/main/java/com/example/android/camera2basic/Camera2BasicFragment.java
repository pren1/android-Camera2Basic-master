            ...
            switch (mState) {
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    if (afState == null) {
                        ...
                        // aeState结果可能为null, 但在我的google pixel上并不是这样的！yeah
                        if(aeState==null) Log.e("MyCV","aeState is null!");
                        //AE has a good set of control values for the current scene.
                        if (aeState == null ||
                                aeState == CaptureResult.CONTROL_AE_STATE_CONVERGED) {
                            mState = STATE_PICTURE_TAKEN;
                            Log.e("MyCV","normal capture!");
                            captureStillPicture();
                        } else {
                            // 进行capture之前的准备
                            Log.e("MyCV","pre capture!");
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.e("MyCV","height = "+largest.getWidth());
